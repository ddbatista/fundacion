 ...
 <div class="container">
    <div class="row"> 
        ...
        echo form_open("Register", $attributes);?> 
            ...
            <div class="col-lg-8 col-sm-8">
                <input id="lastname" name="lastname"  type="text" autocomplete = "off" class="form-control"  value="<?php echo set_value('lastname'); ?>" />
                <br><br>
            ...
            <div class="row colbox">
            <div class="col-lg-4 col-sm-4">
                <label for="tutor" class="control-label">Nombre del tutor</label>
            </div>
            <div class="col-lg-8 col-sm-8">
                <input id="tutor" name="tutor" autocomplete = "off" type="text" class="form-control"  value="<?php echo set_value('tutor'); ?>" />
                  <br><br>
                <span class="text-danger"><?php echo form_error('tutor'); ?></span>
            </div>
            </div>
            </div>
            ...
            <div class="row colbox">
            <div class="col-lg-4 col-sm-4">
                <label for="procedencia" class="control-label"></label>
            </div>
            <div class="col-lg-8 col-sm-8">
            
                <select name="procedencia"> 
              <option value="N/A">Procedencia del Paciente</option>
                <option value="Comedor">Comedor Infantil Caritas</option>
                <option value="Afiliado">Afiliado</option>
                <option value="Sacerdote">Sacerdote</option>
                <option value="Religiosa">Religiosa</option>
                <option value="Seminarista">Seminarista</option>
                <option value="Novicio">Novicios (as)</option>
                <option value="Laico">Laicos (as)</option>
            ...
            <div class="col-sm-offset-4 col-lg-8 col-sm-8 text-left">
                ...
                <input id="btn_addod" name="btn_addod" type="submit" class="btn btn-primary" value="Realizar Odontodiagrama" />
            </div>
            </div>
