...
<html>
 ...
 <div class="container">
    <div class="row"> 
        ...
        echo form_open("Odontodiagrama_C/Historial_zona", $attributes);?> 
            <div class="form-group">
            <div class="row colbox">
            <div class="col-lg-4 col-sm-4">
            <article id="Trat"> 
                <label for="odonto_medico" >Elija la Zona de trabajo</label>
            </article>
            </div>
            <div class="col-lg-8 col-sm-8">
              <?php
                ...
                ?>
                <input id="btn_zona" name="btn_zona" type="submit" value="Próximo" />
