               ...
               // echo "<br>Listado de odontodiagramas<br><br><br><br>";
                ...
                echo "<ul>";
                  for($i=0; $i<$size; $i++){
                    ...
                    /*"<li><a href=\"view_odontodiagrama.php?view=".$info[$i][1]."\" class='linkk'>".$tipo." - ".$info[$i][1]."</a></li><br><br><br>";*/
                    //echo "view es".$info[$i][2];
                    echo "<li><a href=\"https://www.fundacionsdivinoninojesus.com/Odontodiagrama_C/Visualizacion_Odonto/".$info[$i][0]."/".$info[$i][2]."\" class='linkk'>".$paciente[$i]." - ".$tipo." - ".$info[$i][2]." - ".$zona[$i][0]." </a></li><br><br><br>";
                  }
                echo "</ul>";
